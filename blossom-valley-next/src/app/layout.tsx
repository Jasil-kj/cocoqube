...
export const metadata: Metadata = {
  title: "Cocoqube | Sustainable Coir Solutions",
  description: "Sustainable luxury for global horticultural markets. Crafting excellence from the heart of the tropics.",
};
